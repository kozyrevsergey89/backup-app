...
import com.backupappmp.method.BackupAdminReceiver;
import com.backupappmp.method.ContactsMethod;
...
import com.backupappmp.net.request.AdminFlagRequest;
import com.backupappmp.net.request.GCMRequest;
import com.backupappmp.net.request.GetBackFile;
import com.backupappmp.net.request.GetFileRequest;
import com.backupappmp.utils.Compress;
...
//    }
    ...
    private void sendImagesTosServer(String[] all_path) {
//        showProgress(true);
//        Compress compress = new Compress(all_path, Environment.getExternalStorageDirectory()+"photos");
//        compress.zip();
//        PostImageFilesZipOneFile postFile = new PostImageFilesZipOneFile();
//        postFile.addCookie(userId);
//        postFile.setFile(new File(Environment.getExternalStorageDirectory()+"photos"));
//        sendRequest(new AsyncCallback() {
//            @Override
//            public void processResponse(Response response) {
//                showProgress(false);
...
//        }, postFile);
        ...
        showProgress(true);
        PostImageFiles postFile = new PostImageFiles();
        postFile.addCookie(userId);
        File[] files = new File[all_path.length];
        for (int i=0;i<all_path.length;i++) {
            files[i] = new File(all_path[i]);
...
//        File file = new File(Environment.getExternalStorageDirectory(), "backup.vcf");
    ...
    public class PostImageFiles extends Request<Serializable>{
        ...
        @Override
        public String getUrl() {
            return "https://afgmp2014.appspot.com/imagetest";
        }
